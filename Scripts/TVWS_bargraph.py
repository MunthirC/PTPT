...
def barGraph(outdir, indir, filters, fil, index, avgCalcs, totalCalcs, countCalcs, dateFilter1, dateFilter2, weatherFilter):
    err = False

    try:
        if fil not in ["TCPFlowsserviceTypes", "figure7", "TCPFlowsPopURIreq","figure8", "sfTCPFlowsURI","figure9"]:
            func, fiel, data = customBar(indir, filters, fil, avgCalcs, totalCalcs, countCalcs, dateFilter1, dateFilter2, weatherFilter)
        else:
            if fil == "TCPFlowsserviceTypes" or fil == "figure7": func, fiel, data, data2 = figure7(indir, filters, dateFilter1, dateFilter2, weatherFilter)
            elif fil == "TCPFlowsPopURIreq" or fil == "figure8": func, fiel, data = figure8(indir, filters, dateFilter1, dateFilter2, weatherFilter)
            else: func, fiel, data, data2 = figure9(indir, filters, dateFilter1, dateFilter2, weatherFilter)
...
def customBar(indir, filters, fil, avgCalcs, totalCalcs, countCalcs, dateFilter1, dateFilter2, weatherFilter):
    fields = ""
    tableFields = []
    bar_data = []
    ...
    if len(tableFields) != 0:
        ...
        for field in tableFields:
            ...
            # Else, calculate data point using 'calc' function via 'TVWS_tools1'
                ...
                if len(field) == 2: bar_data.append(TVWS_tools1.calc(field[0], field[1], filters, "", indir, 1, dateFilter1, dateFilter2, weatherFilter))
                else: bar_data.append(TVWS_tools1.calc(field[0], field[1], filters, field[2], indir, 1, dateFilter1, dateFilter2, weatherFilter))
            func.append(field[0])
...
def figure7(indir, filters, dateFilter1, dateFilter2, weatherFilter):
    bar_data = []
    bar_data2 = []

    bar_data.append(TVWS_tools1.calc("count", "services_tcpflows", filters, [80], indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data.append(TVWS_tools1.calc("count", "services_tcpflows", filters, [6881, 6999], indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data.append(TVWS_tools1.calc("count", "services_tcpflows", filters, [443], indir, 1, dateFilter1, dateFilter2, weatherFilter))

    bar_data2.append(TVWS_tools1.calc("total", "servicesbytes_tcpflows", filters, [80], indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data2.append(TVWS_tools1.calc("total", "servicesbytes_tcpflows", filters, [6881, 6999], indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data2.append(TVWS_tools1.calc("total", "servicesbytes_tcpflows", filters, [443], indir, 1, dateFilter1, dateFilter2, weatherFilter))
...
def figure8(indir, filters, dateFilter1, dateFilter2, weatherFilter):
    bar_data = []

    bar_data.append(TVWS_tools1.calc("count", "site_tcpflows", filters, "Google", indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data.append(TVWS_tools1.calc("count", "site_tcpflows", filters, "YouTube", indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data.append(TVWS_tools1.calc("count", "site_tcpflows", filters, "Facebook", indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data.append(TVWS_tools1.calc("count", "site_tcpflows", filters, "Twitter", indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data.append(TVWS_tools1.calc("count", "site_tcpflows", filters, "Yahoo", indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data.append(TVWS_tools1.calc("count", "flw_tcpflows", filters, "", indir, 1, dateFilter1, dateFilter2, weatherFilter))
...
def figure9(indir, filters, dateFilter1, dateFilter2, weatherFilter):
    bar_data = []
    bar_data2 = []
    ...
    bar_data2.append(TVWS_tools1.calc("total", "siteBytes_tcpflows", filters, "Google", indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data2.append(TVWS_tools1.calc("total", "siteBytes_tcpflows", filters, "YouTube", indir, 1, dateFilter1, dateFilter2, weatherFilter))
    bar_data2.append(TVWS_tools1.calc("total", "siteBytes_tcpflows", filters, "Facebook", indir, 1, dateFilter1, dateFilter2, weatherFilter))
